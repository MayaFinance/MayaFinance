# Hi, I’m Ambuj 👋  
### Machine Learning Engineer • First-Principles Thinker • Builder

Welcome to my GitHub.  
This profile represents my long-term commitment to **understanding, building, and scaling systems from first principles**—not just using abstractions, but deriving them.
...
- ML systems fundamentals (data pipelines, experimentation, deployment basics)
...
- Systems that combine **math + code + real-world impact**

> If your work values *depth over buzzwords*, we’ll get along.
...
- Bridging theory → implementation → production
...
## ⚡ Fun Fact
I’m obsessed with **deriving models before coding them** —  
if I can’t explain *why* it works, I don’t trust *that* it works.
...
If you’re here to **build deeply**, welcome.
